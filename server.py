    ...
    def handle_gemini_audit(self):
        try:
            ...
            system_instruction = (
                ...
                "- Medications & Routine: Linaclotide 290mcg (morning secretagogue), Mestinon 180mg daily (cholinergic parasympathetic boost), Prucalopride 2mg (bedtime 5-HT4 propulsive wave trigger), Electrolytes in water (sodium/potassium/magnesium for colonic mucosal hydration and secretagogue fluid draw), and EAAs (Essential Amino Acids) for muscular energy and repair without GI digestive burden.\n"
