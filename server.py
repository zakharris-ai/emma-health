...
def generate_autonomous_exercise_audit(query, cycle_day, phase, luteal_double=True):
    ...
    is_menstrual = "menstrual" in p or "reset" in p or (1 <= c_day <= 4)
    is_follicular = ("follicular" in p or (5 <= c_day <= 13)) and not is_menstrual
    is_ovulation = "ovulation" in p or (14 <= c_day <= 16)
    is_luteal = ("luteal" in p or c_day >= 17) and not is_menstrual and not is_follicular and not is_ovulation
    ...
    def handle_gemini_audit(self):
        try:
            ...
            system_instruction = (
                ...
                "- Medications & Routine: Linaclotide 290mcg (morning secretagogue), Mestinon 180mg daily (cholinergic parasympathetic boost), Prucalopride 2mg (bedtime 5-HT4 propulsive wave trigger), Senna tea (occasional rescue anthraquinone stimulant for severe delay), Electrolytes in water (sodium/potassium/magnesium for colonic mucosal hydration and secretagogue fluid draw), and EAAs (Essential Amino Acids) for muscular energy and repair without GI digestive burden.\n"
                "- APD, Gassiness & Burpiness: Emma tracks upper vs lower bloating, gassiness, and burpiness (supragastric belching, aerophagia, or stuck gas) to distinguish true transit from diaphragmatic spasm.\n"
                ...
                "- STRICT NO MACROS / CALORIES RULE: Emma does NOT track calories or macros (P/C/F) due to ADHD sensory/anxiety triggers. NEVER mention calories, macros, grams of protein/carbs/fat, or calorie targets in your responses. Focus purely on digestive kinetics, transit comfort, and gut mechanics.\n"
                "- BANANA & CARBOHYDRATE SCIENCE (EMMA'S FUEL): Firm Cavendish bananas (yellow with slight green tips) or frozen bananas in shakes (100g–115g+) are Monash low-FODMAP certified. They are rich in gut-protective resistant starch (RS2) that feeds colonic butyrate bacteria rather than fermenting into gas. DO NOT restrict Emma to 40–50g banana; when paired with Kallo puffed white rice cakes, M&S Made Without Wheat gluten-free flakes, and sunflower/almond butter, this provides essential, bloat-free clean carbohydrate fuel for adult ADHD focus and active days without triggering APD or splenic flexure pain.\n"
                "- EMMA'S 21 VERIFIED PERSONAL SAFE RECIPES (Always approve with theme 'green' & badge 'Safe to Enjoy'):\n"
                "  * Dinners: Fish & Prawn Rice Bowl, Tuna & Prawn Stirfried Rice Bowl (130g Rice), Prawn Rice Poke Bowl (200g Rice), MORE Prawn Rice Poke Bowl (170g Rice), Turkey Bolognese & Rice Bowl (120g Rice), Turkey Bolognese & Butternut Squash Bowl, Turkey Bolognese & Quinoa Bowl, Tuna & Egg White Jacket Potato.\n"
                "  * Breakfasts: Banana Almond Rice Cakes (x3), Crispy Berry & Banana Yogurt Breakfast Bowl (115g Banana), Homemade Perfect Matcha Shake, Cacao Homemade Perfect Matcha Shake, Form Homemade Perfect Matcha Shake.\n"
                "  * Lunches: Turkey Burger & Marmite Rice Cakes (6 EW), Spinach Eggs (w) & RC, Ham & Egg Rice Cakes, Tuna & Beetroot Rice Cakes.\n"
                "  * Bulk Prep: Cottage Cheese Turkey Burgers (Makes 7), Turkey & Veggie Bolognese Base (Makes 3).\n"
                "  * Desserts: M&S Strawb Frito (120g), Oddono's Banana or Fruit Sorbet (in a cup).\n"
    ...
    def handle_gemini_exercise_audit(self):
        try:
            ...
            system_instruction = (
                ...
                f"- CURRENT HORMONAL CONTEXT: Cycle Day {cycle_day} ({phase_label}). Remember each cycle stage is physiologically distinct: menstrual follicular (Days 1–4) is the silent menses reset with rock-bottom hormones, progesterone withdrawal, and uterine prostaglandins requiring gentle restorative movement; rising follicular (Days 5–13) is the estrogen ramp with climbing estradiol, peak dopamine, faster baseline transit, and high strength tolerance; ovulation (Days 14–16) has peak energy; luteal (Days 17–28) has high progesterone which relaxes bowel smooth muscle, slowing transit and making the diaphragm hyper-reactive.\n"
